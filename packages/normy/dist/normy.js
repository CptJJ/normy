...
var createNormalizer = function createNormalizer(normalizerConfig, initialNormalizedData) {
  ...
  var getQueriesById = function getQueriesById(mutationDependencies) {
    return (0,_get_queries_dependent_on_mutation__WEBPACK_IMPORTED_MODULE_7__.getQueriesDependentOnMutation)(normalizedData.dependentQueries, Array.isArray(mutationDependencies) ? mutationDependencies : [mutationDependencies]);
  };
  var getQueriesToUpdate = function getQueriesToUpdate(mutationData) {
    ...
    var foundQueries = getQueriesById(Object.keys(updatedObjects));
