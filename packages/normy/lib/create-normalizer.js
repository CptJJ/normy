...
var createNormalizer = exports.createNormalizer = function createNormalizer(normalizerConfig, initialNormalizedData) {
  ...
  var getQueriesById = function getQueriesById(mutationDependencies) {
    return (0, _getQueriesDependentOnMutation.getQueriesDependentOnMutation)(normalizedData.dependentQueries, Array.isArray(mutationDependencies) ? mutationDependencies : [mutationDependencies]);
  };
